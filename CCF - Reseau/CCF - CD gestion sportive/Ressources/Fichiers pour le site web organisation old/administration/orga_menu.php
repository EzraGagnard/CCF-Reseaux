        ...
        <table style="text-align: center" border="0" width="800px" cellpadding="2" bordercolor="#808080" cellspacing="6">
			...
			<tr>
			    <td bordercolor="#C0C0C0" bgcolor="#D0D0D0"><p style="text-align: center">
					<a href="http://phpmyadmin.esr72.fr"><img border="0" src="../images/phpmyadmin.png" width="48" height="48"></a></p>
					<p style="text-align: center"><b><a href="http://phpmyadmin.esr72.fr">Gestion base<br />de données</a></b>
                </td>
                ...
                <td bordercolor="#C0C0C0" bgcolor="#D0D0D0"><p style="text-align: center">
                    ...
                    <p style="text-align: center">
					<b><a href="competition.php">Gerer les <br />compétitions</a></b>
                </td>
