...
// ajout du champ Numéo de dossard
...
// recherche des infos en fonction de id de l'engagé à modifier
    ...
    if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
			...
			$engagement = mysql_fetch_object ($resultat);
        }
...
<div id="contenu" style="width: 90%;">
     <h2>Modification Engagement<br />
     </h2>
     <div class="item">
     <p>informations engagé(e) : </p>
     <form method="post" action="<?php echo $_SERVER['SCRIPT_NAME']."?&competition=".urlencode(stripslashes($_GET['competition'])) ?>"  name="engagement" onSubmit="return verif();">
     ...
     <tbody>
      ...
      <tr>
        <td>Nom</td>
        <td><input name="nom" value="<?php echo $engagement->nom; ?>" onKeyPress="return pasNum(event)" onChange="majuscule(this)"/></td>
        <td>Prénom</td>
        <td><input name="prenom" value="<?php echo $engagement->prenom; ?>" onKeyPress="return pasNum(event)" /></td>
      </tr>
      <tr>
        <td>Année de naissance</td>
        <td><input name="anneenaissance" size="4" value="<?php echo $engagement->anneenaissance; ?>" onKeyPress="return pasCar(event)" onChange="verif_nais(this)"/>
        </td>
        <td>Sexe</td>
      ...
      <tr>
        <td>Tel</td>
        <td><input name="tel" value="<?php echo $engagement->tel; ?>" size="12" /></td>
		<td>Email</td>
        <td><input name="email" value="<?php echo $engagement->email; ?>" size="50" onChange="testMail(this)"/></td>
...
<div id="pied"> Site hébergé par Endurance72 -  - 72000 LE MANS - Tél: 02.43.23.64.18<br />
</div>
</div>
</body></html>
