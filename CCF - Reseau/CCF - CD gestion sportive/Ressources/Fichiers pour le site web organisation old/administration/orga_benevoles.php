...
//-->
     ...
     <div id="contenu" style="width: 1024px; min-height:500px;">
        ...
        <div id="outils">
               ...
               <a href="orga_benevole_ajouter.php" title="Ajouter un bénévole"><img border="0" src="../images/addusers.png"></a>
               <div id="rechercher">
...
<?php
     ...
     // Si la variable lettre n'exite pas on commence par la lettre A classé par nom_prof
   ...
   makeListLettre($lien);
    ...
    echo '</div><table id="tableau">'."\n"
       ...
       . "<th><a href='".$lien."&ordre=telephone&lettre=".$_GET['lettre']."'>Tél</a></th>"
